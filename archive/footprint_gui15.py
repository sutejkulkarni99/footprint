...
class PinCalibrationApp(QMainWindow):
    def __init__(self):
        ...
        self.select_square_button = QPushButton("Select Square")
        self.select_square_button.clicked.connect(self.start_selecting_square)
        self.select_square_button.setEnabled(False)
        self.control_layout.addWidget(self.select_square_button)

        self.submit_square_button = QPushButton("Submit Square Points")
        self.submit_square_button.clicked.connect(self.submit_square_points)
        self.submit_square_button.setEnabled(False)
        self.control_layout.addWidget(self.submit_square_button)
    ...
    def load_image(self):
        ...
        self.select_square_button.setEnabled(True)
    ...
    def on_mouse_click(self, event):
        if self.selecting_square:
            ...
            if len(self.square_points) == 4:
                ...
                self.submit_square_button.setEnabled(True)
    ...
    def submit_square_points(self):
        ...
        # Notify the user
        self.update_result_text("Square points submitted. You can now calibrate the ruler for pixel-to-mm conversion.")
