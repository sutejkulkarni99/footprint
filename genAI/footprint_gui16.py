...
class PinCalibrationApp(QMainWindow):
    def __init__(self):
        ...
        self.load_button.setFixedSize(120, 30)  # Smaller button size
        ...
        self.square_button.setFixedSize(120, 30)  # Smaller button size
        ...
        self.calibrate_button.setFixedSize(120, 30)  # Smaller button size
        ...
        self.pins_button.setFixedSize(120, 30)  # Smaller button size
        ...
        self.add_row_button.setFixedSize(120, 30)  # Smaller button size
        self.control_layout.addWidget(self.add_row_button, 4, 0)  # Row 4, Column 0

        self.reset_button = QPushButton("Reset")
        self.reset_button.clicked.connect(self.reset)
        self.reset_button.setEnabled(False)
        self.reset_button.setFixedSize(120, 30)  # Smaller button size
        ...
        self.calculate_pitch_button.setFixedSize(120, 30)  # Smaller button size
        ...
        self.generate_drawing_button.setFixedSize(120, 30)  # Smaller button size
        ...
        self.control_layout.addWidget(self.result_text_edit, 8, 0, 1, 2)  # Row 8, Span 2 columns
